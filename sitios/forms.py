...
class TakeoutForm(forms.Form):
    fotos = forms.BooleanField(label=_(u'Fotografías'), required=False)
    comentarios = forms.BooleanField(label=_(u'Comentarios'), required=False)
    sitios_enviados = forms.BooleanField(label=_(u'Sitios enviados'), required=False)
    sitios_favoritos = forms.BooleanField(label=_(u'Sitios favoritos'), required=False)